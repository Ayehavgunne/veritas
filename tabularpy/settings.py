...
class Settings(object):
	def __init__(
		...
		time_format='%H:%M:%S', header_formatter=None, label_formatter=None,
		cell_formatter=None, sort_headers=False, int_comma=True,
		dec_comma=True, float_comma=True, dont_format=()
	):
